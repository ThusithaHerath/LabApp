                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form method="POST" action="{{url('application-action/'.$data->id)}}">
                                            {{ csrf_field() }}
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4">Serial Number</label>
                                                    <input type="number" class="form-control rounded" id="inputName4" placeholder="Serial Number" value="{{$data->serial_number}}" disabled>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4">Sample Type</label>
                                                    <input type="text" class="form-control rounded" id="inputName4" placeholder="Sample Type" value="{{$data->sample_type}}" disabled>
                                                </div>
                                                
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4"># of Samples</label>
                                                    <input type="number" class="form-control rounded" id="inputName4" placeholder="# of Samples" value="{{$data->number_of_samples}}" disabled>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4">Test type</label>
                                                    <input type="number" class="form-control rounded" id="inputName4" placeholder="Test type" value="{{$data->test_type}}" disabled>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6"> 
                                                    <input name="pm1" type="text" class="form-control rounded" id="inputName4"  value="{{$data->pm_1}}" disabled>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <input name="re1" type="text" class="form-control rounded" id="inputName4" value="{{$data->re_1}}" disabled>
                                                </div>
                                                <div class="form-group col-md-6"> 
                                                    <input name="pm2" type="text" class="form-control rounded" id="inputName4" value="{{$data->pm_2}}" disabled >
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <input name="re2" type="text" class="form-control rounded" id="inputName4" value="{{$data->re_2}}" disabled>
                                                </div>
                                                <div class="form-group col-md-6"> 
                                                    <input name="pm3" type="text" class="form-control rounded" id="inputName4" value="{{$data->pm_3}}" disabled>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <input name="re3" type="text" class="form-control rounded" id="inputName4" value="{{$data->re_3}}" disabled>
                                                </div>
                                                <div class="form-group col-md-6"> 
                                                    <input name="pm4" type="text" class="form-control rounded" id="inputName4" value="{{$data->pm_4}}" disabled>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <input name="re4" type="text" class="form-control rounded" id="inputName4" value="{{$data->re_4}}" disabled>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4">View Minute</label>
                                                    <input type="text" class="form-control rounded" id="inputName4" placeholder="Add Minute"  value="{{$data->minute}}" disabled>
                                                </div>
                                            </div>

                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4">Certificate number </label>
                                                    <input name="certificate_no" type="number" class="form-control rounded" id="inputName4"  value="{{$data->certificate_number}}" placeholder="Certificate number" disabled>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4">Status</label>
                                                    <select name="status" id="Occupation" class="form-control">
                                                        <option selected>Choose Stutus</option>
                                            ...
                                            <a href="{{url('applicationlist')}}" class="btn btn-danger ">
                                                <span>Cancel</span>
                                            </a>
                                        </form>
                                    </div>
