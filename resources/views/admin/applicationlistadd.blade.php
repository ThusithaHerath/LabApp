                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <h4 class="card-title">Add Sample</h4>
                        </div>
                                        ...
                                        <form method="POST" action="{{url('add-application')}}">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input name="snumber" type="number" class="form-control rounded" id="inputName4" placeholder="Serial Number">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4">Recived Date</label>
                                                    <input name="date" type="date" class="form-control rounded" id="inputName4" placeholder="Recived Date">
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input name="customer" type="text" class="form-control rounded" id="inputName4" placeholder="Customer">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4">VAT</label>
                                                    <input name="vat" type="number" class="form-control rounded" id="inputName4" placeholder="VAT">
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input name="testtype" type="text" class="form-control rounded" id="inputName4" placeholder="Test Type">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4">Payment Amount</label>
                                                    <input name="amount" type="number" class="form-control rounded" id="inputName4" placeholder="Payment Amount">
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input name="sample" type="text" class="form-control rounded" id="inputName4" placeholder="Sample Type">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputName4"># of Samples</label>
                                                    <input name="noofsamples" type="number" class="form-control rounded" id="inputName4" placeholder="# of Samples">
                                                </div>
                                                
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputOccupation4">Priority Type</label>
