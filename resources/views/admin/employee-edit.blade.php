                                        ...
                                        <form method="POST" action="{{url('update-employee/'.$user->id)}}">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input name="name" type="text" class="form-control rounded" id="inputName4" value="{{$user->name}}" >
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputOccupation4">Occupation</label>
                                                    <select name="occupation" id="Occupation" class="form-control">
                                                        <option selected value="{{$user->role_id}}" >current role - {{$user->role ? $user->role->role : ''}}</option>
                                                        <option value="2">Lab Assistent</option></option>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input name="email" type="email" class="form-control rounded" id="inputEmail4" value="{{$user->email}}">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="password" class="form-control rounded" id="inputConfirmPassword4" placeholder="Confirm Password">
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-primary">Update</button>
                                            <a href="{{url('employeelist')}}" class="btn btn-danger ">
                                                <span>Cancel</span>
                                            </a>
                                        </form>
                                    </div>
