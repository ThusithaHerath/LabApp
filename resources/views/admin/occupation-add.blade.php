                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        ...
                        <div class="card-header  justify-content-between align-items-center">
                            <h4 class="card-title">Add Occupation</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form method="POST" action="{{url('add-occupation')}}">
                                            {{ csrf_field() }}
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="occupation" id="Occupation" class="form-control">
                                                        ...
                                                        <option value="labassitant">Lab Assistant</option>
