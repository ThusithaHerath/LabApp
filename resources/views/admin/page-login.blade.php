...
<!-- Mirrored from html.designstream.co.in/pick/html/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Sep 2020 21:22:44 GMT -->
...
<body id="main-container" class="default" style="background-image: url('dist/images/infa_Deh_fill_03.jpeg');  background-position: center; background-repeat: no-repeat; background-size: cover; ">
    <!-- START: Main Content-->
    <div class="container ">
            ...
            <div class="col-12 ">
                <form action="# " class="row row-eq-height lockscreen mt-5 mb-5 ">
                    ...
                    <div class="login-form col-12 col-sm-7 ">
                        ...
                        <div class="mt-2 ">Forgot Password? <a href="# ">here</a></div>
                    </div>
                </form>
            </div>
