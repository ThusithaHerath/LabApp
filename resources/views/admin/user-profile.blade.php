...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('dist/css/profilestyle.css')}}">
    <!-- END: Custom CSS-->
</head>
<!-- END Head-->
                    ...
                    <div class="container emp-profile">
                        <form method="post">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                   <a href="{{url('user-profile-edit')}}"> <input type="button" class="profile-edit-btn" name="btnAddMore" value="Edit Profile"/></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
